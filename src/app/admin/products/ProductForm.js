...
export default function ProductForm({ initial, isEdit }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Two-column layout */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid lg:grid-cols-[1fr_280px] gap-6 items-start">
        ...
        <div className="flex flex-col gap-5">
          ...
          {/* Media */}
          <div className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col gap-5">
            <h2 className="text-xs font-bold uppercase tracking-widest text-gray-400">Media &amp; documents</h2>

            <div>
              <label htmlFor="prod-images" className="block text-sm font-semibold text-gray-700 mb-1.5">
                Image URLs
              </label>
              <textarea
                id="prod-images"
              ...
              />
              <p className="text-xs text-gray-400 mt-1">One URL per line. First image is used as the main display image.</p>
            </div>

            <div>
              <label htmlFor="prod-pdf" className="block text-sm font-semibold text-gray-700 mb-1.5">
                Datasheet PDF URL
              </label>
              <input
                id="prod-pdf"
